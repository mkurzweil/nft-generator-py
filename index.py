...
generate_unique_images(number_of_png, {
    "layers": [
        {
            "name": "Background",
            "values" : ["Background_0", "Background_1", "Background_2", "Background_3", "Background_4", "Background_5", "Background_6", "Background_7", "Background_8", "Background_9", "Background_10", "Background_11", "Background_12", "Background_13", "Background_14", "Background_15", "Background_16", "Background_17", "Background_18", "Background_19" ],
            "trait_path": "./trait-layers/backgrounds/collection",
            "filename" : ["background_0", "background_1", "background_2", "background_3", "background_4", "background_5", "background_6", "background_7", "background_8", "background_9", "background_10", "background_11", "background_12", "background_13", "background_14", "background_15", "background_16", "background_17", "background_18", "background_19" ],
            "weights": [86, 49, 34, 78, 80, 32, 31, 72, 37, 19, 12, 67, 49, 20, 73, 72, 76, 76, 54, 62]
        },
        {
            "name": "Foreground",
            "values": ["montain_1", "montain_1"],
            "trait_path": "./trait-layers/foreground/collection",
            "filename": ["Montain_1", "Montain_1"],
            "weights": [50, 50]
        },
        {
            "name": "Branding",
            "values": ["A Name", "Another Name"],
            "trait_path": "./trait-layers/text/collection",
            "filename": ["text", "text"],
            "weights": [50, 50]
        }
    ],
